...
- No API key ships with the add-in. Get one at https://www.juso.go.kr and pass it once as the last argument; it is stored under HKCU\Software\EGTools\ApiKeys and can be omitted afterwards.
