...
- No API key ships with the add-in. Get one at data.go.kr (NTS business-registration status service) and pass it once as the last argument; stored under HKCU\Software\EGTools++\ApiKeys and reused afterwards.
