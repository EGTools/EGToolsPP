...
| 服务 | 用途 | 相关功能 |
|---|---|---|
| juso | 道路名地址搜索 | [SEARCHADDRESS](../SEARCHADDRESS.md) |
| data.go.kr | 节假日·营业登记状态 | [KOREANHOLIDAYS](../KOREANHOLIDAYS.md) · [日历/日程表](calendar.md#节假日说明) · [BRNSTATUS](../BRNSTATUS.md) |
| vworld | 地图/坐标 | [GEOSEARCH](../GEOSEARCH.md) · [GEOCODER](../GEOCODER.md) · [GEOADDRESS](../GEOADDRESS.md) · [ADDRESSMAP](../ADDRESSMAP.md) |
...
- 这一个密钥由 [KOREANHOLIDAYS](../KOREANHOLIDAYS.md)（特日信息）、
  [日历/日程表](calendar.md#节假日说明)的临时节假日合并、
  [BRNSTATUS](../BRNSTATUS.md)（国税厅营业登记状态）**共同使用**。
