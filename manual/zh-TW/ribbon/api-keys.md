...
| 服務 | 用途 | 相關功能 |
|---|---|---|
| juso | 道路名地址搜尋 | [SEARCHADDRESS](../SEARCHADDRESS.md) |
| data.go.kr | 節假日、營業登記狀態 | [KOREANHOLIDAYS](../KOREANHOLIDAYS.md) · [行事曆/日程表](calendar.md#節假日說明) · [BRNSTATUS](../BRNSTATUS.md) |
| vworld | 地圖/座標 | [GEOSEARCH](../GEOSEARCH.md) · [GEOCODER](../GEOCODER.md) · [GEOADDRESS](../GEOADDRESS.md) · [ADDRESSMAP](../ADDRESSMAP.md) |
...
- 這一把金鑰由 [KOREANHOLIDAYS](../KOREANHOLIDAYS.md)（特定日資訊）、
  [行事曆/日程表](calendar.md#節假日說明)的臨時節假日合併、
  [BRNSTATUS](../BRNSTATUS.md)（國稅廳營業登記狀態）**共同使用**。
