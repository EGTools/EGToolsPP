...
| サービス | 用途 | 関連機能 |
|---|---|---|
| juso | 道路名住所の検索 | [SEARCHADDRESS](../SEARCHADDRESS.md) |
| data.go.kr | 祝日・事業者登録状態 | [KOREANHOLIDAYS](../KOREANHOLIDAYS.md) · [カレンダー/予定表](calendar.md#祝日の案内) · [BRNSTATUS](../BRNSTATUS.md) |
| vworld | 地図/座標 | [GEOSEARCH](../GEOSEARCH.md) · [GEOCODER](../GEOCODER.md) · [GEOADDRESS](../GEOADDRESS.md) · [ADDRESSMAP](../ADDRESSMAP.md) |
...
- この 1 つのキーを [KOREANHOLIDAYS](../KOREANHOLIDAYS.md)（祝日等の特日情報）、
  [カレンダー/予定表](calendar.md#祝日の案内)の臨時祝日の反映、
  [BRNSTATUS](../BRNSTATUS.md)（国税庁の事業者登録状態）が**すべて共有**します。
