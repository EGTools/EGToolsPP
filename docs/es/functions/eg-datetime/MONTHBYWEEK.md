...
```
=MONTHBYWEEK(fecha, [inicio_semana], [dia_propietario])
```
...
|---|---|---|
| `=MONTHBYWEEK(DATE(2026,2,1))` | 1 | La semana del domingo 1 de febrero pertenece a enero |
| `=MONTHBYWEEK(DATE(2026,2,2))` | 2 | La semana del 2 de febrero pertenece a febrero |
...
- Compatibilidad: Excel 2010+. Se registra siempre como `MONTHBYWEEK` en todas las versiones de Excel.
