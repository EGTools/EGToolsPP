...
- Los argumentos alt_text, height y width se aceptan por compatibilidad pero se ignoran; con resize_mode 0 (predeterminado) la imagen se ajusta dentro de la celda manteniendo la relación de aspecto y se centra (los demás valores llenan la celda).
